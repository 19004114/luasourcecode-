...
void SecondDialog::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDOK, btn_ChapNhan);
}
...
BEGIN_MESSAGE_MAP(SecondDialog, CDialog)
	...
	ON_BN_CLICKED(IDOK, &SecondDialog::OnBnClickedOk)
...
void SecondDialog::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDrawItemStruct)
{
